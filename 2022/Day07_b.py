...
all_sizes = directory_sizes(file_system)
current_size = all_sizes[-1]
needed_size = UPDATE_SIZE - (TOTAL_SIZE - current_size)

print(min([dirt for dirt in all_sizes if dirt >= needed_size]))
